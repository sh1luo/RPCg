...
func (x *ProtoReply) GetServiceMethod() string {
	if x != nil {
...
func (x *ProtoReply) GetSeq() uint64 {
	if x != nil {
		return x.Seq
	}
	return 0
...
func (x *ProtoReply) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
var file_reply_proto_rawDesc = []byte{
	...
	0x65, 0x70, 0x6c, 0x79, 0x22, 0x5a, 0x0a, 0x0a, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x52, 0x65, 0x70,
	0x6c, 0x79, 0x12, 0x24, 0x0a, 0x0d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x4d, 0x65, 0x74,
	0x68, 0x6f, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x65, 0x71, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x73, 0x65, 0x71, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x72,
	0x72, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72,
	0x42, 0x09, 0x5a, 0x07, 0x2e, 0x3b, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_reply_proto_goTypes = []interface{}{
	(*ProtoReply)(nil), // 0: reply.ProtoReply
}
